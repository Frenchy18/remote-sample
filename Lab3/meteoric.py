...
def load_data():
    ...
    try:
        with open('meteorite_landings_full.csv', encoding='utf-8', newline='') as csvfile:
...
def main():
    ...
    if command == '1' or command == 'year':
        ...
        result = find_recclass(meteors, arg)
...
# Chris implemented recclass function
def find_recclass(meteors, recclass):
